...
| `platform.image.tag`                          | Conduktor Platform image tag (immutable tags are recommended)                                                                                                 | `1.18.2`                       |
...
| `platformCortex.image.tag`                          | Conduktor Platform Cortex image tag (immutable tags are recommended)                                                                                                 | `1.18.2`                              |

...
| `config.database.host`                 | Your Conduktor Platform Database host                                                                                                                  | `postgresql.conduktor`         |
| `config.database.port`                 | Your Conduktor Platform Database port                                                                                                                  | `5432`                         |
| `config.database.name`                 | Your Conduktor Platform Database name                                                                                                                  | `conduktor`                    |
...
| `config.existingLicenseSecret`         | Name of an existing secret containing the license                                                                                                      | `license-secret`               |
| `config.existingSecret`                | Name of an existing secret containing sensitive configuration                                                                                          | `creds-secret`                 |

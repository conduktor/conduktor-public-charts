...
| `platform.image.repository`                   | Conduktor Platform image repository                                                                                                                           | `conduktor/conduktor-console` |
| `platform.image.tag`                          | Conduktor Platform image tag (immutable tags are recommended)                                                                                                 | `1.21.0`                       |
...
| `platformCortex.image.repository`                   | Conduktor Platform Cortex image repository                                                                                                                           | `conduktor/conduktor-console-cortex` |
| `platformCortex.image.tag`                          | Conduktor Platform Cortex image tag (immutable tags are recommended)                                                                                                 | `1.21.0`                              |

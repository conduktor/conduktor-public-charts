...
| `config.kafkasql.database.host`        | Your Conduktor Console Kafka SQL host                                                                                                                | `""`       |
| `config.kafkasql.database.port`        | Your Conduktor Console Kafka SQL port                                                                                                                | `5432`     |
| `config.kafkasql.database.username`    | Your Conduktor Console Kafka SQL username                                                                                                            | `""`       |
| `config.kafkasql.database.password`    | Your Conduktor Console Kafka SQL password                                                                                                            | `""`       |

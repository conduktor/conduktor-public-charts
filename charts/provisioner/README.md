...
| Name                                | Description                                                                                                                  | Value       |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `console.enable`                    | Enable Console provisioning                                                                                                  | `true`      |
...
| `console.existingConfigmap`         | The name of an existing ConfigMap with your custom configuration for conduktor-provisioner                                   | `nil`       |
| `console.command`                   | Override default conduktor-provisioner container command (useful when using custom images)                                   | `[]`        |
| `console.args`                      | Override default conduktor-provisioner container args (useful when using custom images)                                      | `[]`        |
...
| `gateway.enable`                    | Enable Gateway provisioning                                                                                                  | `true`      |
| `gateway.url`                       | URL of the Console                                                                                                           | `""`        |
| `gateway.username`                  | Username to authenticate on the Console                                                                                      | `""`        |
| `gateway.password`                  | Password to authenticate on the Console                                                                                      | `""`        |

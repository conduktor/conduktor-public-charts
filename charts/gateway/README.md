...
| `tls.keystoreKey`                          | DEPRECATED: use tls.keystore.keystoreKey instead. Key in the secret to load as keystore                                                                                                                                                                                                           | `""`             |
| `tls.keystoreFile`                         | DEPRECATED: use tls.keystore.keystoreFile instead. File name to mount keystore as                                                                                                                                                                                                                 | `""`             |

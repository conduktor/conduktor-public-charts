...
helm repo update
helm install myProxy conduktor/conduktor-proxy
```
...
| `proxy.secretSha256sum`     | Optional sha256sum of the referenced secret. This could be set to have a automactic restart of proxy deployment if secret change | `""`                                                                                                                                                                                                                                                                                                                    |
...
| `proxy.startupProbeDelay`   | Optional delay in second before startup probe should be running (default 10)                                                     | `""`                                                                                                                                                                                                                                                                                                                    |
...
| `proxy.volumes`             | Define user specific volumes for proxy deployment                                                                                | `{}`                                                                                                                                                                                                                                                                                                                    |
| `proxy.volumeMounts`        | Define user specific volumeMounts  for proxy container in deployment                                                             | `{}`                                                                                                                                                                                                                                                                                                                    |
